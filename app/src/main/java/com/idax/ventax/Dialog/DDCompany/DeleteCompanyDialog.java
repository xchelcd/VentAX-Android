...
public class DeleteCompanyDialog extends DialogFragment {
    ...
    public DeleteCompanyDialog(CompanyFView companyFView, CompanyFPresenter presenter, int companyId, int state, boolean type) {
        //type true -> delete
